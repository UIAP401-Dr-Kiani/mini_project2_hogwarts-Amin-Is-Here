                ...
                while (true)
                {
                    ...
                    { 
                        ...
                        if (Units > 6)
                        {
                            ...
                            Console.Clear();
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine(" Your Units Are Full");
                            Console.ResetColor();
                            StudentMainPage();
                        }
                        else
                        {
                            ...
                            {
                                if (student.Name == File.ReadAllText("Student.txt")  && student.Start== StartTime && student.End== EndTime)
                                {
                                    variable++;
                                }
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    Name =  File.ReadAllText("Student.txt"),
                                    Lesson = "sport",
                                    Start = StartTime,
                                    End = EndTime,
                                    Term = NumTerm
